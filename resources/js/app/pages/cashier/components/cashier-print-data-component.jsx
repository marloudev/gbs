                ...
                <div className="flex w-full items-center justify-center mb-52">
                    <div className="w-72 ">
                        <img
                            ...
                            alt="chippz"
                            className="mx-auto w-16 py-4 font-semibold text-black"
                        />
                        <div className="flex flex-col justify-center items-center gap-2">
                            <h4 className="font-semibold">GBS Minimart</h4>
                            <p className="text-xs text-center font-semibold m-0">
                                Corner of V. Gustilo Street and S. Carmnona
                                Street.
                            </p>
                        </div>
                        <div className="flex flex-col gap-3 border-b  text-xs">
                            <p className="flex justify-between mx-5 my-0">
                        ...
                        <div className="flex flex-col gap-3 pb-6  text-xs">
                            <table className="w-full text-left px-4">
                                <thead>
                                    <tr className="flex">
                                        <th className="w-full ">Products</th>
                                        <th className="min-w-[44px]">Price</th>
                                        <th className="min-w-[44px] ">QTY</th>
                                        <th className="min-w-[44px] ">Total</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {cart.map((res, index) => {
                                        return (
                                            <tr key={index} className="flex">
                                                <td className="font-semibold text-xs flex-1 py-1">
                                                    {res.product.description ??
                                                        ""}
                                                </td>
                                                <td className="font-semibold text-xs min-w-[44px]">
                                                    ₱{res.price ?? 0}
                                                </td>
                                                <td className="font-semibold text-xs min-w-[44px]">
                                                    {res.quantity ?? 0}
                            ...
                            <div className="font-semibold  justify-center items-center flex flex-col gap-2 mb-50">
                            ...
                            <div className="flex items-center justify-center">
                                <Barcode
                                    value={String(payment.receipt_id) ?? "0"}
                                />
                            </div>
                            <div className="justify-center items-center flex flex-col gap-2 ">
                                -------------------------
                            ...
                            <div className="py-4 font-semibold text-black justify-center items-center flex flex-col gap-2 mb-50">
                                Only Defective or damage items will be accepted
                                for return or exchange and subject to DTI rules
                                on return/exchange. Bring this Receipt to return
                                or exchange within 7days from purchase date.
                            </div>
